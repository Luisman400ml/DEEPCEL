...
wire        wCLK8, wCLK6, wCLK64, wCLK120;
...
// Low-frequency variant: PLL c0 is 6 MHz and feeds only this small NN design.
assign wVID_CLK   = wCLK6;
assign wVID_CLKx5 = wCLK120;
assign wCLK8      = iCLK;
assign wNN_CLK    = wCLK6;
...
jtag_interface #(
	...
	.iMAIN_CLK(wCLK120),
	.iDATA({64'b0, {24'b0,to_arduino_prediction_light}, {24'b0,to_arduino_prediction_temperature}}), // predictions mapped to SAMD21 read registers 0 and 1
